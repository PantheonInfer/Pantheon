...
class DataModule(pl.LightningDataModule):
    ...
    def setup(self, stage):
        if stage == 'fit':
            ...
            dataset = Scene15(os.path.join(self.hparams.data_dir, 'Scene-15'), train=True, transform=transform)
        ...
        if stage == 'test':
            ...
            self.dataset_test = Scene15(os.path.join(self.hparams.data_dir, 'Scene-15'), train=False, transform=transform)
