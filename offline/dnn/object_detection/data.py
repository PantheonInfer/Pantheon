...
from .indoor_smart_traffic import IndoorSmartTraffic
import sys
sys.path.append('../..')
...
class DataModule(pl.LightningDataModule):
    ...
    def train_dataloader(self):
        ...
        for name in image_sets:
            dataset = IndoorSmartTraffic(self.hparams.data_dir, name, transform=train_transform, target_transform=target_transform)
