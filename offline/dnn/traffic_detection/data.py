...
class DataModule(pl.LightningDataModule):
    ...
    def train_dataloader(self):
        ...
        self.train_dataset = VOCDataset(os.path.join(self.hparams.data_dir, 'traffic_dataset_vocformat'), transform=train_transform, target_transform=target_transform, is_test=False)
