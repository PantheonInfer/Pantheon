...
class DataModule(pl.LightningDataModule):
    ...
    def train_dataloader(self):
        ...
        self.train_dataset = VOCDataset(os.path.join(self.hparams.data_dir, 'Wildfire_Smoke'), transform=train_transform, target_transform=target_transform, is_test=False)
